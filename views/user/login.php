		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					...
					<br><br>
							<a class="primary-btn" href="<?php echo base_url('index.php/UserCtr/register');?>">Create an Account</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="<?php echo base_url('index.php/UserCtr/userlogin');?>" method="post" id="loginForm" novalidate="novalidate">
